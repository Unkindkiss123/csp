...
$page_title = 'Backoffice · Utilizadores';
    ...
    <div class="row g-3">
      <aside class="col-lg-3">
        <div class="list-group sticky-top" style="top: calc(var(--site-header-h) + 1rem);">
          ...
          <a class="list-group-item list-group-item-action active" href="./gestor_utilizadores.php">Utilizadores</a>
      ...
      <section class="col-lg-9">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h1 class="h4 text-primary mb-0">Gestor de utilizadores</h1>
          <button class="btn btn-primary" disabled>Novo utilizador</button>
        </div>
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td><?= $i ?></td>
                <td>Utilizador <?= $i ?></td>
                <td>user<?= $i ?>@exemplo.pt</td>
                <td><span class="badge bg-info text-dark">Cliente</span></td>
                <td><span class="badge bg-success">Ativo</span></td>
                <td class="text-end">
                  <button class="btn btn-sm btn-outline-primary" disabled>Editar</button>
                  <button class="btn btn-sm btn-outline-danger" disabled>Suspender</button>
                </td>
              </tr>
              <?php endfor; ?>
            </tbody>
