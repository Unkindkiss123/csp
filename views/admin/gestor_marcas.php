    ...
    <div class="row g-3">
      <aside class="col-lg-3">
        <div class="list-group sticky-top" style="top: calc(var(--site-header-h) + 1rem);">
          ...
          <a class="list-group-item list-group-item-action active" href="./gestor_marcas.php">Marcas</a>
          <a class="list-group-item list-group-item-action" href="./gestor_contactos.php">Contactos</a>
        </div>
      </aside>
      <section class="col-lg-9">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h1 class="h4 text-primary mb-0">Marcas</h1>
          <button class="btn btn-primary" disabled>Nova marca</button>
        </div>
